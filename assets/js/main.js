...
;(function () {
   ...
   */
  window.addEventListener('load', () => {
    let awardsContainer = select('.awards-container')
    if (awardsContainer) {
      let awardsIsotope = new Isotope(awardsContainer, {
        itemSelector: '.awards-item',
      })

      let awardsFilters = select('#awards-flters li', true)
  ...
  /**
   * Initiate awards lightbox
   */
  const awardsLightbox = GLightbox({
    selector: '.awards-lightbox',
  })
